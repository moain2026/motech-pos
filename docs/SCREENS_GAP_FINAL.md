...
| **2026-07-06 (لينات A/B/C/D + تكامل)** | **64** | **2** | **6** (+8📄) | **80% صارمة / 90% بعد N/A** |
| **2026-07-06 (لينات E/F/G + تكامل — نهائي P2)** | **72** | **0** | **0** (+8📄 N/A) | **90% صارمة / 100% بعد N/A** |

> **2026-07-06 الموجة P2 الأخيرة (مُثبتة حياً):** Lane E — POST001 محرك العروض (PROMO_MST/DTL + `/promotions/apply` حي 401) + الدفع بالكوبون/البطاقة المسبقة/استبدال النقاط + POSADVS وضع الكيوسك/ملء الشاشة. Lane F — POSI004 اختصارات + POSI005/006 الموازين (SCALE_DEFINITIONS) + POS_IMPXLS استيراد Excel/CSV. Lane G — POSS003 نسخ احتياطي. **التكامل:** أُعيد ترقيم مهاجرات Lane E → V031/V032 (تصادم V029/V030)، backend+frontend tsc صفر، **337 اختبار أخضر**، بناء+نشر نظيف، الدومين 200. **كل الشاشات القابلة للبناء مُنجزة — الـ100% الوظيفي تحقّق.**
