...
**POST: ✅ 14 · 🟡 10 · ❌ 6** _(تدقيق فجر 2026-07-04: +POST019 وPOST023 بواجهتيهما — POST018 يبقى 🟡 بلا UI)_ _(2026-07-04: POST001/010/013/021 صارت ✅ — الواجهة رُبطت بالكامل)_
...
|---|:---:|:---:|:---:|:---:|
| حركات POST | 30 | **14** | 10 | 6 |
| تقارير POSR | 16 | **15** | 1 | 0 |
| إدخال POSI | 15 | **7** | 4 | 4 |
| إعدادات POSS | 9 | **2** | 2 | 5 |
| أخرى | 10 | **3** | 2 | 5 |
| **الإجمالي** | **80** | **41** | **19** | **20** |

> تفصيل العدّ الصارم (لمراجعة مستقبلية):
> - **POST ✅ 14:** 001,002,003,004,010,013,016,017,019(TransfersPage),021,023(PrescriptionsPage),025,026,027 · 🟡 10: 005,006,008,009,011,012,014,015,018(بلا UI),020 · ❌ 6: 022,024,028,029,POSTIN_MTX,POST_WST
...
> - من الـ❌ 20: **8 شاشات N/A معمارياً** (4×WMS، POS_INSTALL، POSI014، POST_WST، POSTIN_MTX) — الناقص الحقيقي القابل للبناء 12 شاشة فقط.
...
- **مرجّحة (كاملة=1، جزئية=0.5):** (41 + 19×0.5)/80 = 50.5/80 = **63.1%** _(كانت 52.5%)_
