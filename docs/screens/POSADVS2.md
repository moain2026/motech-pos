# POSADVS2 — توثيق شاشة Onyx Pro POS

> النوع: **POSADVS** — شاشات لمس/متقدمة (Advanced/Touch)  
> الحجم: 105,872 bytes · فك witchi: ✅ كامل · المصدر: `D:\YS_ERP\Forms\POSADVS2.fmx`

## 1. الوظيفة

_(لا يوجد ملف مساعدة مطابق؛ الوظيفة مُستنتَجة من النوع والـ SQL)_

شاشة من فئة **شاشات لمس/متقدمة (Advanced/Touch)**. أكثر الجداول استخداماً: `S_BRN`, `IAS_SYS`, `IAS_POS_HUNG_BILLS`, `IAS_POS_MACHINE`, `IAS_PARA_GEN`, `V$SESSION`.
...
**قياسية (Forms events):** `ON-ERROR`, `ON-MESSAGE`, `PRE-FORM`, `WHEN-NEW-FORM-INSTANCE`, `WHEN-TIMER-EXPIRED`

## 6. Program Units (2)


**Procedures/Functions (2):** `LOAD_PARAMETERS`, `SET_OPEN_SCRN_SESSION`
...
**حِزَم DB المُستدعاة (PL/SQL packages):** `IAS_GEN_PKG`, `IAS_USR_PKG`, `IAS_ITM_PKG`, `GEN_PKG`, `SETUP_PKG`
...
- عدد الجُمل/الأسطر في ملف strings: راجع `_raw/POSADVS2_strings.txt`.
