# POSADVS_SCND — توثيق شاشة Onyx Pro POS

> النوع: **POSADVS** — شاشات لمس/متقدمة (Advanced/Touch)  
> الحجم: 146,296 bytes · فك witchi: ✅ كامل · المصدر: `D:\YS_ERP\Forms\POSADVS_SCND.fmx`
...
| POS_BILL_DTL_INFO | DB | QIU | IMMEDIATE | ORDER:RCRD_NO |
...
| --- | --- | --- | --- |
| MAIN | CONTENT | 760×548 | visible |
| MAIN2 | STACKED | 760×548 | visible |
...
- عدد الجُمل/الأسطر في ملف strings: راجع `_raw/POSADVS_SCND_strings.txt`.
