# POSS006 — توثيق شاشة Onyx Pro POS

> النوع: **POSS** — إعدادات/نظام (Settings/System)  
> الحجم: 406,392 bytes · فك witchi: ✅ كامل · المصدر: `D:\YS_ERP\Forms\POSS006.fmx`
...
- عدد الجُمل/الأسطر في ملف strings: راجع `_raw/POSS006_strings.txt`.
