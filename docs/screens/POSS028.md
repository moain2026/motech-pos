# POSS028 — توثيق شاشة Onyx Pro POS

> النوع: **POSS** — إعدادات/نظام (Settings/System)  
> الحجم: 406,380 bytes · فك witchi: ✅ كامل · المصدر: `D:\YS_ERP\Forms\POSS028.fmx`
...
- عدد الجُمل/الأسطر في ملف strings: راجع `_raw/POSS028_strings.txt`.
